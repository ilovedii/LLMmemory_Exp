...
# plt.bar(x + offsets[2], jac_low_ratio_without, bar_width, label='jac_low_ratio (without mem0)', color="#d38e8e")
# plt.bar(x + offsets[3], jac_low_ratio_with, bar_width, label='jac_low_ratio (with mem0)', color="#ffaeae", hatch='////', edgecolor='white')
# plt.bar(x + offsets[4], main_persist_without, bar_width, label='main_persist (without mem0)', color="#d6c044")
# plt.bar(x + offsets[5], main_persist_with, bar_width, label='main_persist (with mem0)', color='#f7dd52', hatch='////', edgecolor='white')
